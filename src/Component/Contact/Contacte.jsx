...
export default function ContactForm() {
  ...
  return (
    <div className="max-w-full mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl  text-green-800 font-bold text-center mb-4">Contact us</h2>
      <form onSubmit={handleSubmit} className="space-y-4 text-black font-semibold">
        <input
          ...
          className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-green-800"
          required
        />
        <input
          type="email"
        ...
        <textarea
          ...
          required
        ></textarea>
        <button type="submit" className="w-full bg-green-800 text-white p-2 rounded-sm hover:bg-green-700">
          Submit
        </button>
